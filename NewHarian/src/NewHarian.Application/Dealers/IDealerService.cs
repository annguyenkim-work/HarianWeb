...
public interface IDealerService
{
    ...
    Task<(bool Ok, string? Error)> ApproveAsync(int id, decimal discountPercent, string? notes, string? userId, string? citizenId = null, CancellationToken ct = default);
    Task<(bool Ok, string? Error)> RejectAsync(int id, string? notes, string? userId, CancellationToken ct = default);
    Task<(bool Ok, string? Error)> SaveApprovedAsync(int id, decimal discountPercent, string? notes, string? userId, string? citizenId = null, CancellationToken ct = default);
