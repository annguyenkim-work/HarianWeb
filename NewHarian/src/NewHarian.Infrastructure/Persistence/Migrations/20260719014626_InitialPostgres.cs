    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameVi = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingProvinces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ColorDefinitionTranslations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ColorDefinitionId = table.Column<int>(type: "integer", nullable: false),
                    LanguageCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorDefinitionTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ColorDefinitionTranslations_ColorDefinitions_ColorDefinitio~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeSlides_MediaFiles_MediaFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "text", nullable: false),
                    Message = table.Column<string>(type: "text", nullable: false),
                    AttachmentMediaFileId = table.Column<int>(type: "integer", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    InternalNotes = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobApplications_MediaFiles_AttachmentMediaFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentBlocks_MediaFiles_MediaFileId",
                        column: x => x.MediaFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingDistrict = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShippingProvinces_ShippingProvinceId",
                        column: x => x.ShippingProvinceId,
                        principalTable: "ShippingProvinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingRates_ShippingProvinces_ProvinceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_ColorDefinitions_ColorDefinitionId",
                        column: x => x.ColorDefinitionId,
                        principalTable: "ColorDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    HomeSlideId = table.Column<int>(type: "integer", nullable: false),
                    LanguageCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorDefinitionTranslations_ColorDefinitionId_LanguageCode",
                table: "ColorDefinitionTranslations",
                columns: new[] { "ColorDefinitionId", "LanguageCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_MediaFileId",
                table: "ContentBlocks",
                column: "MediaFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentBlockTranslations_ContentBlockId_LanguageCode",
                table: "ContentBlockTranslations",
                columns: new[] { "ContentBlockId", "LanguageCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HomeSlides_MediaFileId",
                table: "HomeSlides",
                column: "MediaFileId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeSlideTranslations_HomeSlideId_LanguageCode",
                table: "HomeSlideTranslations",
                columns: new[] { "HomeSlideId", "LanguageCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_AttachmentMediaFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ColorDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingProvinces_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteSettingTranslations_SiteSettingId_LanguageCode",
                table: "SiteSettingTranslations",
                columns: new[] { "SiteSettingId", "LanguageCode" },
                unique: true);
